...
import Gimg1 from '../../images/project-single/img1.jpg'
import Gimg2 from '../../images/project-single/img2.jpg'
                                        ...
                                        <div className="col-lg-5">
                                            <div className="wpo-project-single-content-des-right">
                                                <ul>
                                                    ...
                                                    <li>Project Type :<span>Mechanical Works</span></li>
                                                    <li>Duration :<span>6 Month</span></li>
                                                    <li>Completion :<span>{ProjectDetails.date}</span></li>
                                    ...
                                    <div className="wpo-project-area-s2 single">
                                        <div className="row align-items-center">
                                            <div className="wpo-project-wrap">
                                                <div className="row">
                                                    {Projects.slice(0,3).map((project, item) => (
