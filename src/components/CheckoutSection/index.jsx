                  ...
                  <div className="chCardBody">
                    <Collapse in={tabs.payment} timeout="auto">
                      <RadioGroup
                        ...
                        onChange={(e) => changeHandler(e)}
                      >
                        <FormControlLabel value="cash" control={<Radio color="primary" />} label="Payment By Card " />
                        <FormControlLabel value="card" control={<Radio color="primary" />} label="Cash On delivery" />
                      </RadioGroup>
                      ...
                      <Collapse in={forms.payment_method === 'card'} timeout="auto">
                        <div className="cardType">
                          <Link to='/order_received' className="cBtn cBtnLarge cBtnTheme mt-20 ml-15" type="submit">
                            Proceed to Checkout
                          </Link>
                        </div>
                      </Collapse>
