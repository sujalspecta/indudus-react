                        ...
                        <div className="wpo-blog-content">
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack">Planning</Link></li>
                                        <li><Link to="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack">Industrial</Link></li>
                                        <li><Link to="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack">Creative</Link></li>
                                    </ul>
                                </div>
                            </div>
